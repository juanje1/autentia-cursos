package com.juanje.cursosboot.data;
...
import static com.juanje.cursosboot.domain.Level.ELEMENTARY;
...
public class CourseRepositoryIT {
    ...
    public void saveShouldSaveTestCourse() {
        ...
        Page<Course> courses = sut.findByTeacherId(1L, PageRequest.of(0, 100, Direction.ASC, "name"));
